...
DEMO VIDEO : https://youtu.be/NYzvRgSPUxA?si=ZQt_C3ByNteebZwI
...
**Step 2:** Create a Models Folder In Main Folder and paste the downloaded model in that Models Folder, Download the model from the given model link: https://www.kaggle.com/models/pranavmishra443/facenet-model
...
NOTE : 
1) IF YOU GET CONFUSE KINDLY SEE FOLDER STRUCTURE PROPERLY
2) AND WHILE RUUNING THE CODE IF SOME DEPENDENCIES GIVE ERROR : KINDLY DOWNLOAD THAT DEPENDENCY OR FRAMEWORK IN VS CODE TERMINAL ONLY
